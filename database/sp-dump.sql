...
MySQL - 5.7.26-0ubuntu0.16.04.1 : Database - ipaycards_db
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`ipaycards_db` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `delete_entity_attribute_values`(IN _entity_id INT,IN _attribute_id INT , IN _table VARCHAR(100) )
BEGIN
