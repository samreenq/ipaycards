					...
					<div class="col-md-12 col-lg-12">
						...
						{{--	<div class="toolbar-small-search">
							...
							<ul class="download-btn">
								<li><a href="javascript:void(0)"><img src="<?php echo url('/').'/public/web/img/ios-btn-app.png';?>" alt="app btn" width="168"/></a></li>
								<li><a href="javascript:void(0)"><img src="<?php echo url('/').'/public/web/img/play-btn-app.png';?>" alt="app btn" width="168"/></a></li>
							</ul>
						</div>
					</div>
				</div>
