    ...
    <td>
        <table width="100%" Class="wishlistWrapper" id="wishlist-{!! $wishlistItems["entity_id"] !!}">
            ...
            <tr>
                ...
                <td><a href="javascript:void(0);" class="wishlist-cart" data-wishlist-id="{!! $wishlistItems["wishlist_entity_id"] !!}" data-id="{!! $wishlistItems["entity_id"] !!}"><span class="icon-tt-cart-Icon"></span></a>
                    <a href="javascript:void(0);" onclick="deleteWishlistProduct('{{ $wishlistItems['entity_id'] }}','{{ route('add_to_cart') }}','{{ route('show_cart') }}','{{route('total_price')}}','{{route('add_to_wishlist')}}','{{route('delete_to_wishlist')}}' )" > <!--class="clancelItem" -->
