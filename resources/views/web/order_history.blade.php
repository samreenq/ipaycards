...
@extends("web.templates.template3")
				...
				<div class="row">
					...
					<input type="hidden" class="order_id" value="1" />
						...
						<div class="orderHistory">
									...
									<div style="position: absolute;top: 50%;left: 50%;-webkit-transform: translate(-50%, -50%);-moz-transform: translate(-50%, -50%);-ms-transform: translate(-50%, -50%);-o-transform: translate(-50%, -50%);transform: translate(-50%, -50%);" id="LoadingImageOrders" align="center" style="display: none">
	...
	@section("orderDetailmodal")
	
		@include("web/includes/models/orderDetailmodal")
	@endsection
	
	@section("orderReviewmodel")
	
		@include("web/includes/models/orderReviewmodel")
	@endsection
	...
	@section("foot")
		...
		$('#pagination').pagination(
		{
			...
			onInit: function () 
			{
				...
				order_history_list(15,"{{route('order_history_list')}}","{{ route('get_order_detail') }}","{{ route('get_order_review_detail') }}",offset,limit);
			},
			...
			signin("{{ route('signin') }}");
			//signup("{{ route('signup') }}");
			getOrderDetail("{{ route('get_order_detail') }}");
			getOrderReview("{{ route('get_order_review_detail') }}");
