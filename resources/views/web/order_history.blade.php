			...
			<div class="container">
				<div class="row">
					<div class="dashboardLeftBar col-md-12 col-lg-3 col-xl-2">
						<aside>
							<ul class="sidebar__inner">
								<li class=""><a href="{{ route('account_detail') }}">Your Account</a></li>
								<li class=""><a href="{{ route('payment') }}">Payment</a></li>
								<li class="active"><a href="{{ route('order_history') }}">Order History</a></li>
								{{--<li class=""><a href="{{ route('address_book') }}">Address Book</a></li>--}}
								<li class=""><a href="{{ route('customer_wallet') }}">Wallet</a></li>
					...
					<input type="hidden" class="order_id" value="1" />
						...
						<div class="orderHistory">
									...
									<div 	style="
											...
											id="LoadingImageOrders" align="center" style="display: none"
									>
