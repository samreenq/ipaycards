...
<section id="content_wrapper" class="content">
    <section id="content" >
<header class="fixed-top container-fluid v-center">
    <div class="row v-center">
        ...
        <div class="col-md-5">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          {{--  <button class="btn btn-primary btn-orange btn-sm">Today</button>--}}
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<section>
    <table border="0" class="table">
        <tr>
            <td width="235px">
                <nav class="sideLeftNav fixed-top max-width">
                    <div class="datepicker-here" id="fixed-dp" data-language='en'></div>

                </nav>
            </td>
            <td style="padding: 60px 0px 70px 20px;height: -webkit-fill-available;">
...
<div class="setEventCustomModalContainer">
    <div class="setEventCustomModal">
        <div class="setEventCustomModalHeader">
            <!-- <b class="modal-heading">Add Event</b> -->
            <a hfef="#" class="closeModal float-right"><i class="fa fa-times"></i></a>
        </div>
