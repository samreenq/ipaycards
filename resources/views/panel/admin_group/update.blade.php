          ...
          <div class="row">
            <div class="col-md-12 ">
              ...
              <div class="section mb10">
                ...
                @if ($data->{$pk} == 1)
                <input disabled="disabled" type="text" id="name" name="name" value="{!! $data->name !!}" placeholder="Enter Group Name" class="gui-input" >
                @else
                <input class="gui-input" type="text" id="name" name="name" value="{!! $data->name !!}" placeholder="Enter Group Name">
                @endif
                </label>
      						...
      						<table class="table">
                                  ...
                                  <!-- has child-->
      								...
      								<tr>
      								    <td>
      								        {!! $i !!}. {!! $j !!}
      								        <input type="hidden" name="modules[]" value="{!! $c_record->admin_module_id !!}" /><input type="hidden" name="parents[]" value="{!! $c_record->parent_id !!}" />
      								    </td>
