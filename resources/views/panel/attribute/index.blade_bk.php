...
<section id="content_wrapper" class="content">
    <section id="content" class="pn">
        <div class="col-md-8 col-md-offset-2 p30">
            ...
            <?php
            function randerInput($field) {
                
                
                
                return '<input type="' . $field->data_type . '" name="' . $field->name . '" id="' . $field->name . '" class="gui-input">';
            }
            ?>
                            ...
                            foreach ($records as $record) {
                                ...
                                <div class="col-md-12">
                                    <div class="section mb20">
                                        <label class="field-label cus-lbl"><?php echo $record->description ?></label>
                                        <label for="" class="field">
                                        <?php
                                        echo randerInput($record);
                                        ?>
                                        </label>
