          ...
          <div class="row">
            <div class="col-md-12">
              <div class="section mb20">
                ...
                <input type="text" name="title" id="title" class="gui-input" value="{!! $data->title !!}">
                </label>
            ...
            <div class="col-md-12">
              <div class="section mb20">
                ...
                <label for="" class="field">
                <textarea name="meta_keywords" id="meta_keywords" class="gui-input">{!! $data->meta_keywords !!}</textarea>
                </label>
            ...
            <div class="col-md-12">
              <div class="section mb20">
                ...
                <label for="" class="field">
                <textarea class="gui-input" id="meta_description" name="meta_description">{!! $data->meta_description !!}</textarea>
                </label>
            ...
            <div class="col-md-12">
              <div class="section mb20">
                ...
                <label for="" class="field">
                <textarea class="gui-input" id="content" name="content">{!! $data->content !!}</textarea>
                </label>
