					...
					<div class="d-v-cell">
						<div class="tab-content text-center">
							<div class="login-form tab-pane fade in active text-center" role="tabpanel" id="login-holder">
								<h2 class="login-header">{!! trans('system.sign_in') !!}</h2>
								<p class="sub-text mb40">{!! trans('system.enter_your_login_details_below') !!}</p>
								...
								<form method="post" action="" class="login-area" name="signin">
									<div class="section mb15">
										<label for="email" class="field prepend-icon">
											<input type="text" name="email" id="email" class="gui-input" placeholder="{!! trans('system.email') !!}" autocomplete="off">
									...
									<div class="section mb20">
										<label for="password" class="field prepend-icon">
											<input type="password" name="password" id="password" class="gui-input" placeholder="{!! trans('system.password') !!}" autocomplete="off">
									...
									<div class="mb30">
										<button type="submit" class="button btn-x-wide btn-theme">{!! trans('system.sign_in') !!}</button>
									</div>
									...
									<div class="footer-links pull-right">
										<p><a href="#forgot-holder" data-toggle="tab">{!! trans('system.forgot_your_password_q') !!}</a></p>
									</div>  
							...
							<div class="forgor-form tab-pane fade" role="tabpanel" id="forgot-holder">
								<h2 class="login-header">{!! trans('system.forgot_password') !!}</h2>
								<p class="sub-text mb40">{!! trans('system.enter_your_login_details_below') !!}</p>
								<form method="post" action=""class="forgot-area" name="forgot">
									...
									@endif
									<div class="mb30">
										<button type="submit" class="button btn-x-wide btn-theme">{!! trans('system.submit') !!}</button>
									</div>    
									<input type="hidden" name="entity_type" value=""/>
								...
								<div class="footer-links">
									...
									<p>{!! trans('system.html_already_have_an_account_q') !!}</p>
								</div>
							</div>    
						</div>     
					</div>    
