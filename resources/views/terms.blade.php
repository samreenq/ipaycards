...
<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Droid+Serif:400,400italic|Montserrat:700,400|Varela+Round">
...
<header id="main-header">
  <div class="container">
    <div class="row">
      <div class="col-lg-12"> <a href="/" class="logo"><img src="{{\URL::to('/')}}/public/images/logo.png" alt="Outdoor Logo"></a> <!-- Your Logo --> 
...
<main id="main-content" class="app-layout"> <!-- margin value is the height of your footer --> 
  ...
  <section id="why-us-3">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="why-us-content privacy-terms">
	    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 centered">
            <h2 class="section-heading">Terms and Conditions ("Terms")</h2>
            <p class="section-title"></p>
          </div>
          <!--/ .col-lg-8 -->
	  <div class="clearfix"></div>
            <p>Last updated: August 30, 2015</p>
            <p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the R4 Outdoor mobile application (the "Service") operated by R4 Enterprise LLC ("us", "we", or "our").</p>
            ...
            <p>R4 Enterprise LLC has the right but not the obligation to monitor and edit all Content provided by users.</p>
            <p>In addition, Content found on or through this Service are the property of R4 Enterprise LLC or used with permission. You may not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or in part, for commercial purposes or for personal gain, without express advance written permission from us.</p>
            <h4>Accounts</h4>
            ...
            <p>The Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of R4 Enterprise LLC and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of R4 Enterprise LLC.</p>
            <h4>Links To Other Web Sites</h4>
            <p>Our Service may contain links to third party web sites or services that are not owned or controlled by R4 Enterprise LLC.</p>
            <p>R4 Enterprise LLC has no control over, and assumes no responsibility for the content, privacy policies, or practices of any third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.</p>
            <p>You acknowledge and agree that R4 Enterprise LLC shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such third party web sites or services.</p>
...
<!-- SmoothScroll --> 
<script src="{{\URL::to('/')}js/minified/SmoothScroll.min.js"></script> 

<!-- ScrollReveal --> 
<script src="{{\URL::to('/')}js/minified/scrollReveal.min.js"></script> 

<!-- Slick --> 
<script src="{{\URL::to('/')}js/slick/slick.min.js"></script> 
<script src="{{\URL::to('/')}js/urip-slick-carousel-setting.js"></script> 

<!-- Custom JS --> 
<script src="{{\URL::to('/')}js/urip-v2.js"></script>
</body>
</html>