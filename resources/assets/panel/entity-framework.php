<?php
    ...
    $buffer=str_replace("%TITLE%","Entity Framework",$buffer);
    echo $buffer;
?>
            ...
            <div class="adv-search">
                ...
                <div class="topbar-right">
                    <div class="pull-right">
                        ...
                        <button type="button" class="btn-default btn-sm add-new-btn link-unstyled ib" href="add-entity.php"><span class="icon mdi mdi-plus pr5 fs15"></span> Add Entity</button>
                    </div>
                </div>
            </div>    
				...
				<table class="table table-hover" id="datatable2" cellspacing="0" width="100%">
					...
					<tbody>
						<tr>
							...
							<td>
								<span class="cell-tittle">Never</span>
								<span class="cell-description">00:00</span>
							</td>
						...
						<tr>
							...
							<td>post</td>
							<td>
								<span class="cell-tittle">May 17, 2016</span>
								<span class="cell-description">14:45</span>
							</td>
							<td>
								<span class="cell-tittle">Never</span>
						...
						<tr>
							...
							<td>retailer</td>
							<td>
								<span class="cell-tittle">Jun 10, 2016</span>
								<span class="cell-description">14:45</span>
							</td>
							<td>
								<span class="cell-tittle">Jun 15, 2016</span>
								<span class="cell-description">14:45</span>
							</td>
							<td class="hv-btns text-right">
								<button type="button" class="btn btn-default btn-sm" href="#" title="Edit" data-toggle="modal" data-target="#myModal"><span class="icon mdi mdi-eye fs13"></span></button>
				...
				<table width="100%" >
					<tr>
						...
						<td width="70%" colspan="2">
							<span class="cell-tittle">Post</span>
						</td>
					</tr>
					<tr>
						<th>Identifier</th>
