		...
		<div class="col-md-8 col-md-offset-2 p30">
			<form action="#" method="">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="section mb20">
								<label class="field-label cus-lbl">First Name</label>
								<label for="" class="field">
									<input type="text" name="names" id="" class="gui-input" placeholder="Johan">
								</label>
							</div>
						</div>			
						<div class="col-md-6">
							<div class="section mb20">
								<label class="field-label cus-lbl">Last Name</label>
								<label for="" class="field">
									<input type="text" name="names" id="" class="gui-input" placeholder="Losert">
								</label>
							</div>
						</div>
					</div>	
				...
				<div class="row">
					<div class="col-md-12 mt0 mb10">
						<h3>Account Info</h3>
						<p>Here you can change the email address you use on Glimmer, and you</p>
					</div>
				</div>
				<div class="main admin-form ">
					<div class="row r-vm">
						<div class="col-md-6">
							<div class="section mb20">
								<label class="field-label cus-lbl">E-mail Address</label>
								<label for="" class="field">
									<input type="text" name="names" id="" class="gui-input" placeholder="example@glimmer.com">
								</label>
							</div>
						</div>
						<div class="col-md-6">
				...
				<div class="main admin-form ">
					<div class="row">
						<div class="col-md-4">
							<div class="section mb20">
								<label class="field-label cus-lbl">Current Password</label>
								<label for="" class="field">
									<input type="password" name="pass" id="" class="gui-input" placeholder="Password">
								</label>
							</div>
						</div>
						<div class="col-md-4">
							<div class="section mb20">
								<label class="field-label cus-lbl">New Password</label>
								<label for="" class="field">
									<input type="password" name="pass" id="" class="gui-input" placeholder="Password">
								</label>
							</div>
						...
						<div class="col-md-4">
							<div class="section mb20">
								<label class="field-label cus-lbl">Confirm Password</label>
								<label for="" class="field">
									<input type="password" name="pass" id="" class="gui-input" placeholder="Password">
								</label>
							</div>
