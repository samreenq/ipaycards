    ...
    <section id="content_wrapper">
      ...
      <section id="content">
        ...
        <div class="admin-form theme-primary mw600" style="margin-top: 3%;" id="register">
          ...
          <div class="panel bg-transparent br-n mt10">

            <form method="post" action="/" id="contact">
              <div class="panel-body bg-transparent p25 pb15">
				...
				<div class="section">
					<div class="text-center mt30">
						<button type="submit" class="button btn-primary fluid-width">Register</button>
