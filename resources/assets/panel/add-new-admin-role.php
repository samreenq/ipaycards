			...
			<div class="col-md-8 col-md-offset-2 p30">
				...
				<form action="#" method="">
					<div class="main admin-form ">
						<div class="row">
							<div class="col-md-12 mt0 mb5">
								<h3>Title</h3>
							</div>
							<div class="col-md-12">
								<div class="section mb10">
									<label class="field-label cus-lbl">Name</label>
							...
							<div class="col-md-6">
								<div class="section mb10">
									...
									<label for="" class="field">
										<input type="email" name="email" id="" class="gui-input">
									</label>
								</div>
							</div>
							<div class="col-md-12 mt0 mb5">
								...
								<div class="section mb10">
									...
									<label class="field select">
										<select id="" name="">
											...
											<option value="madmin">Master Admin</option>
							...
							<div class="col-md-6">
								<div class="section mb10">
									...
									<label for="" class="field">
										<input type="password" name="passwrod" id="" class="gui-input" >
									</label>
								</div>
							</div>
						</div>
