<?php
    ...
    $buffer=str_replace("%TITLE%","Levels",$buffer);
    echo $buffer;
?>
            ...
            <div class="adv-search">
                ...
                <div class="topbar-right">
                    <div class="pull-right">
                        ...
                        <button type="button" class="btn-default btn-sm add-new-btn link-unstyled ib" href="add-new-level.php"><span class="icon mdi mdi-plus pr5 fs15"></span> Add Levels</button>
                    </div>
                </div>
            </div>    
			...
			<table class="table table-hover" id="datatable2" cellspacing="0" width="100%">
				...
				<tbody>
					...
					<tr>
						...
						<td > 
							Level 4 - QA- Continents-Europe-France-Saint Tropez-location_easy_Saint Tropez
						</td>
						<td>Q/A</td>
						<td>0</td>
						<td>0</td>
