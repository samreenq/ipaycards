<?php
    ...
    $buffer=str_replace("%TITLE%","Question",$buffer);
    echo $buffer;
?>
            ...
            <div class="adv-search">
                ...
                <div class="topbar-right">
                    <div class="pull-right">
                        ...
                        <button type="button" class="btn-default btn-sm add-new-btn link-unstyled ib" href="add-new-questions.php"><span class="icon mdi mdi-plus pr5 fs15"></span> Add Question</button>
                    </div>
                </div>
            </div>    
			 ...
			 <table class="table table-hover" id="datatable2" cellspacing="0" width="100%">
               ...
               <tbody>
                    <tr>
                        ...
                        <td>1</td>
						<td>
                            Level 2 - Runner - Continents - Europe
                        </td>
                        <td>City - Places A</td>
                        <td style="width:15%;">
			...
			<div class="modal-content">
			  ...
			  <div class="modal-body detail-view">
				<table width="100%" >
					...
					<tr>
						<th>Tag</th>
						<td colspan="3">Level 2 - QA - Continents - North America</td>
					</tr>
					<tr>
						<th>Pool</th>
						<td colspan="3">City - Places B</td>
					</tr>
					<tr>
						<th>Tag</th>
						<td colspan="3">Global.Continents.Asia.China.Beijing</td>
					</tr>
					<tr>
						<th>Date</th>
						<td>
					...
					<tr>
						<th>Question</th>
						<td colspan="3">Who is who, What is what?</td>
					</tr>
					<tr>
						<th>Answer 1</th>
						<td>This is answer 1</td>
						<th>Answer 1 Worth</th>
						<td>1</td>
					</tr>
					<tr>
						<th>Answer 2</th>
						<td>This is answer 2</td>
						<th>Answer 2 Worth</th>
						<td>0</td>
					</tr>
					<tr>
						<th>Answer 3</th>
						<td>This is answer 3</td>
						<th>Answer 3 Worth</th>
						<td>0</td>
					</tr>
					<tr>
						<th>Answer 4</th>
						<td>This is answer 4</td>
						<th>Answer 4 Worth</th>
						<td>0</td>
					</tr>
				</table>
			  </div>
