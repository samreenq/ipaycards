<?php
    ...
    $buffer=str_replace("%TITLE%","All Pages",$buffer);
    echo $buffer;
?>
    ...
    <section id="content_wrapper" class="content">
        ...
        <div class="adv-search">
            ...
            <div class="topbar-right">
                <div class="pull-right">
					...
					<button type="button" class="btn-default btn-sm add-new-btn link-unstyled ib" href="add-cms-page.php"><span class="icon mdi mdi-plus pr5 fs15"></span> Add CMS Page</button>
                </div>
            </div>
        </div>    
        ...
        <section id="content" class="pn table-layout">
            <div class="tray tray-center pn">
                <div class="panel">
					<table class="table table-hover responsive" id="datatable2" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th width="5%" class="nosort not-tablet-l not-tablet-p">
								...
								<th width="25%" class="mobile-l min-tablet">Author</th>
								<th width="20%" class="mobile-l min-tablet">Date</th>
								<th width="20%" class="nosort not-tablet-l not-tablet-p"></th>
								<th width="5%" class="text-right nosort not-tablet-l not-tablet-p" ><button type="button" class="btn-default btn-sm accordion-icon link-unstyled" href="#"><span class="icon mdi mdi-refresh-alt fs15"></span></button></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td>
									<span class="ticon"><i class="icon mdi mdi-view-web"></i></span> 
								</td>
								<td>
								...
								<td style="width: 12%;" class="hv-btns text-right">
									<button type="button" class="btn btn-default btn-sm" onclick=""  title="View" data-toggle="modal" data-target=".view-popup"><span class="icon mdi mdi-eye fs13"></span></button>
									<button type="button" class="btn btn-default btn-sm" onclick="window.location.href='visual-editor.php'" title="Edit"><span class="icon mdi mdi-edit fs13"></span></button>
									<button type="button" class="btn btn-default btn-sm" onclick="" title="Delete"><span class="icon mdi mdi-delete fs13"></span></button>
								</td>
							...
							<tr>
								...
								<td style="width: 12%;" class="hv-btns text-right">
									<button type="button" class="btn btn-default btn-sm" onclick="" title="Edit" data-toggle="modal" data-target="#myModal"><span class="icon mdi mdi-eye fs13"></span></button>
									<button type="button" class="btn btn-default btn-sm" onclick="window.location.href='visual-editor.php'" title="Edit"><span class="icon mdi mdi-edit fs13"></span></button>
									<button type="button" class="btn btn-default btn-sm" onclick="" title="Delete"><span class="icon mdi mdi-delete fs13"></span></button>
								</td>
								<td style="width:5%;" class="text-right">
		  ...
		  <div class="modal-body detail-view">
			<table width="100%" >
				<tr>
					...
					<td width="70%">
						<span class="cell-tittle">Home Page</span>
					</td>
				</tr>
				<tr>
					<th width="30%">Author</th>
					<td width="70%">Administrator</td>
				</tr>
				<tr>
					<th>Date</th>
					<td>
...
<script src="./vendor/plugins/datatables/extensions/Responsive/js/dataTables.responsive.min.js"></script>
