...
$.fn.gridEditor = function( options ) {
    ...
    self.each(function(baseIndex, baseElem) {
        ...
        function setup() {
            ...
            mainControls = $('<div class="ge-mainControls" />');
            ...
            var btnGroup = $('<div class="btn-group pull-right"/>')
                .appendTo(wrapper)
            ;
            var htmlButton = $('<button title="Edit Source Code" type="button" class="btn bg-dark light gm-code"><span class="icon mdi mdi-code fs24"></span></button>')
                .on('click', function() {
                ...
                .appendTo(btnGroup)
            ;
            var previewButton = $('<button title="Preview" type="button" class="btn bg-dark light gm-preview"><span class="icon mdi mdi-eye fs22"></span></button>')
