				...
				<div class="row">
					...
					<div class="col-md-6" id="accordion">
						<div class="text-right">
							<button type="button" class="accordion-toggle btn-default btn-sm accordion-icon link-unstyled collapsed" data-toggle="collapse" data-parent="#accordion" href="#avd-search"><span class="icon mdi mdi-menu"></span></button>
							<button type="button" class="btn-default btn-sm accordion-icon link-unstyled" href="#"><span class="icon mdi mdi-plus pr5 fs15"></span> Add Admin Role</button>
						</div>
					</div>
				</div>
			</div>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th>Created</th>
                    <th>Updated</th>
                    <th class="text-right"><button type="button" class="btn-default btn-sm accordion-icon link-unstyled" href="#"><span class="icon mdi mdi-refresh-alt fs15"></span></button></th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td>Slug One</td>
                    <td>Company</td>
                    <td>2016-01-25 05:26:03</td>
                    <td>2016-09-19 15:14:55</td>
