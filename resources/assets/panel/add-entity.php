						...
						<div class="row">
							<div class="col-md-6">
								<div class="section mb20">	
									<label class="field-label cus-lbl">Identifier</label>
							...
							<div class="col-md-6">
								<div class="section mb20">
									<label class="field-label cus-lbl">Primary Key</label>
									<label for="" class="field">
										<input type="text" name="names" id="" class="gui-input" >
									</label>
								</div>
							...
							<div class="col-md-6">
								<div class="section mb20">
									<label class="field-label cus-lbl">UCWord</label>
									<label for="" class="field">
										<input type="text" name="names" id="" class="gui-input" >
									</label>
								</div>
							...
							<div class="col-md-6">
								<div class="section mb20">
									<label class="field-label cus-lbl">Related / Actor Entity</label>
							...
							<div class="col-md-6">
								<div class="section mb20">
									<label class="field-label cus-lbl">Plural Title</label>
									<label for="" class="field">
										<input type="text" name="names" id="" class="gui-input">
									</label>
								</div>
							...
							<div class="col-md-12">
								<div class="section mb20">
									<label class="field-label cus-lbl">Table SQL Type</label>
									<label class="field select">
										<select id="" name="">
											<option value="none">None</option>
