<!-- Start: Content-Wrapper --> 
            ...
            <div class="adv-search">
				...
				<div class="tabnav-holder">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#ads-achievements-1" data-toggle="tab" aria-expanded="false">Manuall</a></li>
                        <li><a href="#ads-achievements-2" data-toggle="tab" aria-expanded="false">Import</a></li>
                    </ul>
                </div>
        ...
        <section id="content" class="pn">
			<div class="tab-content">
				<div id="ads-achievements-1" class="tab-pane active">
						...
						<form action="#" method="">
							<div class="main admin-form">
								<div class="row">
									...
									<div class="col-md-6">
										<div class="section mb20">
											<label class="field-label cus-lbl">Achievement Type</label>
				...
				<div id="ads-achievements-2" class="tab-pane">
					<div class="col-md-8 col-md-offset-2 p30 mt20">
						<div class="row">
							<div class="col-md-12 mt0 mb25">
								<h3>Information</h3>
