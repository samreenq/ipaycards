...
class OrderController extends WebController {
	...
	public function confirmation(Request $request)
	{
		...
		else
		{
			...
			$order_id	  	= 	$request->input('entity_id');
			...
			if($resp == "00" || $resp == "11" || $resp == "10" )  
			{
				...
				/*
				$response = json_encode(CustomHelper::internalCall($request,"api/system/entities/listing", 'get',['entity_type_id'=>50,'transaction_reference'=>$txn_ref,'mobile_json'=>1],false));
				$json 	  = json_decode($response,true);
