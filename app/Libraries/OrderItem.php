...
Class OrderItem
{
     ...
     * @param $product_id
     */
    public function addGiftCardStock($order_id,$order_item_id,$product_id,$quantity)
    {
     ...
     * @param $quantity
     */
    public function addProductStock($order_id,$order_item_id,$product_id,$quantity)
    {
        for($qty = 1; $qty <= $quantity; $qty++ ) {
            ...
            if ($data && isset($data[0])) {
                ...
                $params = [
                    ...
                    'order_from' => 'in_stock',
                     'vendor_id' => isset($data[0]->vendor_id) ? $data[0]->vendor_id : 0
                ];
     ...
     * @param $deal_id
     */
    public function addDealStock($order_id,$order_item_id,$deal_id,$quantity)
    {
        //Get Deal
        $flat_table = new SYSTableFlat('product');
