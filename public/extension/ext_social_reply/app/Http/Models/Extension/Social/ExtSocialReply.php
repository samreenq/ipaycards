...
class EXTSocialReply extends Base
{

    use SoftDeletes;
    public $table = '{plugin_identifier}';
    public $timestamps = true;
    public $primaryKey = 'social_reply_id';
    protected $dates = ['deleted_at'];
    public $objectIdentifier = "reply";
    public $actionIdentifier = "reply";
    private $_pHook = "ExtSocialReplyModel"; // extension hook
    ...
    public function __construct()
    {
        ...
        // set fields
        $this->__fields = array($this->primaryKey, 'entity_type_extension_map_id', 'target_entity_id', 'actor_entity_id', 'data_entity_id', 'reply', 'json_data', 'created_at', 'updated_at', 'deleted_at');
    }
