...
('form_add','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}'),
('form_update','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}'),
('form_delete','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}'),
('form_field_add','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}'),
('form_field_update','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}'),
('form_field_delete','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}');
