...
class CommentController extends Controller
{
    ...
    public function post(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if (intval($request->input('parent_id', 0)) > 0) {
                $this->_apiData['message'] = trans($this->_langIdentifier . '.reply_insert_success');
            } else {
                $this->_apiData['message'] = trans($this->_langIdentifier . '.comment_insert_success');
            }
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            // api msg
            if (intval($entity['parent_id']) > 0) {
                $this->_apiData['message'] = trans($this->_langIdentifier . '.reply_update_success');
            } else {
                $this->_apiData['message'] = trans($this->_langIdentifier . '.comment_update_success');
            }
