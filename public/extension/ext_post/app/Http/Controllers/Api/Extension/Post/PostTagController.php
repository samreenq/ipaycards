...
class PostTagController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            // api msg
            $this->_apiData['message'] = trans($this->_langIdentifier . '.entity_update_success', array("entity" => $this->_pModel->objectIdentifier));
    ...
    public function delete(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            // api msg
            $this->_apiData['message'] = trans($this->_langIdentifier . '.entity_delete_success', array("entity" => $this->_pModel->objectIdentifier));
