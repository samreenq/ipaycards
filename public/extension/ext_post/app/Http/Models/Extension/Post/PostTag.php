...
class PostTag extends Base
{
    ...
    use SoftDeletes;
    public $table = 'ext_post_tag';
    public $timestamps = true;
    public $primaryKey = 'post_tag_id';
    protected $dates = ['deleted_at'];
    public $objectIdentifier = "post_tag";
    public $actionIdentifier = "post_tag";
    private $_pHook = "ExtPostTag"; // extension hook
    ...
    public function __construct()
    {
        ...
        // set fields
        $this->__fields = array($this->primaryKey, 'title', 'identifier', 'entity_type_extension_map_id', 'actor_entity_id', 'count_usage', 'created_at', 'updated_at', 'deleted_at');
    }
