...
class ExtSocialComment extends Base
{

    use SoftDeletes;
    public $table = '{plugin_identifier}';
    public $timestamps = true;
    public $primaryKey = 'social_comment_id';
    protected $dates = ['deleted_at'];
    public $objectIdentifier = "comment";
    public $actionIdentifier = "comment";
    private $_pHook = "ExtSocialCommentModel"; // extension hook
    ...
    public function __construct()
    {
        ...
        // set fields
        $this->__fields = array($this->primaryKey, 'entity_type_extension_map_id', 'target_entity_id', 'actor_entity_id', 'data_entity_id', 'comment', 'json_data', 'created_at', 'updated_at', 'deleted_at');
    }
