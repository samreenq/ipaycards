...
('review_add','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}'),
('review_update','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}'),
('review_delete','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}');
