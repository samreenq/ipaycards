...
class IndexController extends Controller
{
    ...
    public function post(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $this->_apiData['message'] = trans($this->_langIdentifier . '.already_reviewed', array("entity" => $entity_type->identifier));
        } else {
            // success response
            ...
            // api msg
            $this->_apiData['message'] = trans($this->_langIdentifier . '.entity_insert_success', array("entity" => $entity_type->identifier));
