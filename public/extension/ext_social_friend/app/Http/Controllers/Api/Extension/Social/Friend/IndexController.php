...
class IndexController extends Controller
{
    ...
    public function post(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $this->_apiData['message'] = trans($this->_langIdentifier . '.already_friends', array("entity" => $entity_type->identifier));
        } elseif ($record && ($record->{'actor_' . $this->_entityModel->primaryKey} == $request->{'actor_' . $this->_entityModel->primaryKey})) {
            $this->_apiData['message'] = trans($this->_langIdentifier . '.request_pending', array("entity" => $entity_type->identifier));
        } elseif ($record && ($record->{'target_' . $this->_entityModel->primaryKey} == $request->{'actor_' . $this->_entityModel->primaryKey})) {
            $this->_apiData['message'] = trans($this->_langIdentifier . '.plz_accept_or_reject', array("entity" => $entity_type->identifier));
        } else {
            // success response
            ...
            // api msg
            $this->_apiData['message'] = trans($this->_langIdentifier . '.request_sent', array("entity" => $entity_type->identifier));
    ...
    public function cancel(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            // api msg
            $this->_apiData['message'] = trans($this->_langIdentifier . '.request_cancelled', array("entity" => $entity_type->identifier));
    ...
    public function delete(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $this->_apiData['message'] = trans($this->_langIdentifier . '.not_friends', array("entity" => $entity_type->identifier));
        } else {
            // success response
            $this->_apiData['response'] = "success";
            ...
            // api msg
            $this->_apiData['message'] = trans($this->_langIdentifier . '.friend_deleted', array("entity" => $entity_type->identifier));
    ...
    public function accept(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            // api msg
            $this->_apiData['message'] = trans($this->_langIdentifier . '.request_accepted', array("entity" => $entity_type->identifier));
    ...
    public function reject(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            // api msg
            $this->_apiData['message'] = trans($this->_langIdentifier . '.request_rejected', array("entity" => $entity_type->identifier));
