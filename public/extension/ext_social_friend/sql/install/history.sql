...
('friend_add','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}'),
('friend_cancel','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}'),
('friend_accept','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}'),
('friend_reject','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}'),
('friend_delete','{plugin_identifier}','none',0,0,0,'{wildcard_datetime}');
