...
class ExtFavorite extends Base
{
    ...
    public $objectIdentifier = "favorite";
    public $actionIdentifier = "favorite";
    private $_pHook = "ExtFavoriteModel"; // extension hook
    ...
    public function __construct()
    {
        ...
        // set fields
        $this->__fields = array($this->primaryKey, 'entity_type_extension_map_id', 'target_entity_id', 'actor_entity_id', 'data_entity_id', 'created_at', 'updated_at', 'deleted_at');
    }
    ...
    public function getData($pk_id = 0)
    {
        ...
        if ($record) {
            ...
            // extra keys
            $data->{'is_'.$this->objectIdentifier} = ($this->currentActorID == $record->actor_entity_id) ? 1 : 0;
