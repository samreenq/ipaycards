...
class IndexController extends Controller
{
    ...
    public function post(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $this->_apiData['message'] = trans($this->_langIdentifier . '.already_marked', array("entity" => $entity_type->identifier));
        } elseif ($request->switch == 0 && $id == 0) {
            $this->_apiData['message'] = trans($this->_langIdentifier . '.have_not_marked', array("entity" => $entity_type->identifier));
        } else {
            // success response
            ...
            if ($id > 0) {
                ...
                // api msg
                $this->_apiData['message'] = trans($this->_langIdentifier . '.entity_remove_success', array("entity" => $entity_type->identifier));
                ...
                // api msg
                $this->_apiData['message'] = trans($this->_langIdentifier . '.entity_mark_success', array("entity" => $entity_type->identifier));
            }
