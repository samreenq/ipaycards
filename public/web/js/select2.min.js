...
(function(a) {
    var b=function() {
        ...
        function(a) {
            ...
            ;
            return d.prototype.on=function(a,
            b) {
 ...
 if(this.$element.prop("multiple"))this.current(function(d) {
            ...
            d.prototype._normalizeItem=function(a) {
                ...
                null==a._resultId&&a.id&&null!=this.container&&(a._resultId=this.generateResultId(this.container,
                a)),
                c.extend( {},
                b,
                a)
        ...
        function(a) {
            function b(b, c, d) {
                ...
                if(void 0!==g&&(this.insertTag=g), b.call(this, c, d), a.isArray(e))for(var h=0;
                h<e.length;
                h++) {
            ...
            return b.prototype.query=function(a,
            b,
            c) {
                function d(a, f) {
                ...
                null==b.term||null!=b.page?void a.call(this,
                b,
                c):void a.call(this,
                b,
                d)
            ...
            ,
            b.prototype.createTag=function(b,
            c) {
                var d=a.trim(c.term);
                return""===d?null: {
                    id: d, text: d
            ...
            ,
            b.prototype.insertTag=function(a,
            b,
            c) {
                b.unshift(c)
            }
        ...
        function(a) {
            ...
            ,
            b.prototype.tokenizer=function(b,
            c,
            d,
            e) {
        ...
        b) {
            ...
            ,
            c.prototype.showSearch=function(a,
            b) {
                return!0
            }
            ,
        ...
        function() {
            ...
            ,
            a.prototype.normalizePlaceholder=function(a,
            b) {
            ...
            ,
            a.prototype.removePlaceholder=function(a,
            b) {
        ...
        function(a) {
            ...
            b.prototype.loadMore=function() {
                ...
                this.lastParams);
                b.page++,
                this.trigger("query:append",
                b)
            }
            ,
            b.prototype.showLoadingMore=function(a,
            b) {
        ...
        b) {
            ...
            return c.prototype.bind=function(a,
            b,
            c) {
                var d=this, e=!1;
        ...
        function() {
            ...
            return b.prototype.showSearch=function(b,
            c) {
        ...
        function() {
            ...
            ,
            a.prototype._handleSelectOnClose=function(a,
            b) {
        ...
        function() {
            ...
            ,
            a.prototype._selectTriggered=function(a,
            b) {
        ...
        C) {
            ...
            D.prototype.apply=function(l) {
                ...
                null!=l.ajax&&(l.resultsAdapter=j.Decorate(l.resultsAdapter,
                x)),
                null!=l.placeholder&&(l.resultsAdapter=j.Decorate(l.resultsAdapter,
                w)),
                l.selectOnClose&&(l.resultsAdapter=j.Decorate(l.resultsAdapter,
                A))),
                null==l.dropdownAdapter) {
                    ...
                    if(0!==l.minimumResultsForSearch&&(l.dropdownAdapter=j.Decorate(l.dropdownAdapter,
                    z)),
                    l.closeOnSelect&&(l.dropdownAdapter=j.Decorate(l.dropdownAdapter,
                    B)),
            ...
            D.prototype.reset=function() {
                ...
                e) {
                    ...
                    if(e.children&&e.children.length>0) {
                        ...
                        return f.children.length>0?f:c(d,
                        f)
                    }
        ...
        d) {
            ...
            ,
            e.prototype._resolveWidth=function(a,
            b) {
            ...
            e.prototype._registerDomEvents=function() {
                ...
                this),
                this._syncS=c.bind(this._syncSubtree,
                this),
                this.$element[0].attachEvent&&this.$element[0].attachEvent("onpropertychange",
                this._syncA);
            ...
            ,
            e.prototype._syncSubtree=function(a,
            b) {
                var c=!1, d=this;
                if(!a||!a.target||"OPTION"===a.target.nodeName||"OPTGROUP"===a.target.nodeName) {
                    if(b)if(b.addedNodes&&b.addedNodes.length>0)for(var e=0;
            ...
            b) {
                ...
                a in d) {
                    ...
                    f,
                    g),
                    g.prevented)return void(b.prevented=!0)
                }
                c.call(this,
                a,
                b)
